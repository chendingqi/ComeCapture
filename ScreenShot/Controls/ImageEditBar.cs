...
namespace ScreenShot
{
    public class ImageEditBar : Control
    {
        ...
        {
            CanvasLeft = AppModel.Current.MaskRightWidth > ScreenUi.ScreenWidth - Width ? 0 : ScreenUi.ScreenWidth - AppModel.Current.MaskRightWidth - Width;
        }
        #endregion
        ...
        private void ResetCanvasTop()
        {
            ...
            CanvasTop = AppModel.Current.MaskBottomHeight >= need ? ScreenUi.ScreenHeight - AppModel.Current.MaskBottomHeight + 5
