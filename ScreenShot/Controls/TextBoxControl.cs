...
namespace ScreenShot
{
    ...
    public class TextBoxControl : Control
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            _TextBox.MaxWidth = ScreenUi.Current.MainImage.Width - ScreenUi.Current.MainImage.point.X - 3;
            _TextBox.MaxHeight = ScreenUi.Current.MainImage.Height - ScreenUi.Current.MainImage.point.Y - 3;
        }
        ...
        protected void OnMyFocusValueChanged()
        {
            if (!MyFocus)
            {
                ...
                {
                    ScreenUi.RemoveControl(this);
                }
                else
                {
                    ScreenUi.Current.MainImage.ResetLimit(Canvas.GetLeft(this), Canvas.GetTop(this), (Canvas.GetLeft(this) + ActualWidth), (Canvas.GetTop(this) + ActualHeight));
                    ScreenUi.Register(this);
                }
                ScreenUi.Current.MainImage._Text = null;
            }
        }
        #endregion
    }
