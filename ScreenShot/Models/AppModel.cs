...
namespace ScreenShot
{
    public class AppModel : EntityBase
    {
        ...
        private double _MaskLeftWidth = ScreenUi.ScreenWidth;
        ...
        {
            sb.Clear();
            sb.Append((int)(ScreenUi.Current.MainImage.Width * ScreenUi.ScreenScale));
            sb.Append(" × ");
            sb.Append((int)(ScreenUi.Current.MainImage.Height * ScreenUi.ScreenScale));
